...
public class CardFactory {
    ...
    public static CardActor createVisualCard(String cardJsonText) {
        ...
        if (data.name != null) {
            ...
            } else if (cardName.contains("ADWARE DRONE")) {
                data.abilities.add(new PopUpAbility());
            } else if (cardName.contains("CRYPTO-JACKER")) {
                data.abilities.add(new CryptoJackerAbility());
            } else if (cardName.contains("SHADOW INSTANCE")) {
                data.abilities.add(new ShadowInstanceAbility());
            }
        }
